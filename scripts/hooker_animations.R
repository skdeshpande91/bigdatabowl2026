...
for(ix in 1:(n-1)){
  ...
  png(paste0("hooker_animations/paths_", write_ix, ".png"), width = 8, height = 4.5, units = "in", res = 400)
  par(mar = c(3,1,3,1), mgp = c(1.8, 0.5, 0))
  plot(1, type = "n", 
       xlim = x_lim, 
       ylim = y_lim,
       xlab="", xaxt = "n", yaxt = "n", ylab = "", 
       main = paste("Hooker Interception: Frame", ix))
  ...
  plot(1, type = "n", xlim = c(0,1), ylim = c(0, y_dens_lim), 
       main = paste("Hooker Interception Forecasted Event Probabilities: Frame", ix), 
  ...
  # Separation
  png(paste0("hooker_animations/sep_", write_ix, ".png"), width = 8, height = 4.5, units = "in", res = 400)
  par(mar = c(3,3,2,1), mgp = c(1.8, 0.5, 0))
  plot(1, type = "n", xlim = c(0, n), ylim = c(0, max(test$pred_sep$U95)),
       xlab = "Frame", ylab = "Separation", 
       main = paste("Hooker Interception Forecasted Final Separation: Frame",ix))
