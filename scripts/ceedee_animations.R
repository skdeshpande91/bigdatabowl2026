...
post <- get_posterior_params(paths = paths, init_noise = c(0.5, 0.5, 0.5, 0.5), sigma = 1/12, tau = 1)
...
for(ix in 1:(n-1)){
  ...
  png(paste0("ceedee_animations/paths_", write_ix, ".png"), width = 8, height = 4.5, units = "in", res = 400)
  ...
  png(paste0("ceedee_animations/probs_", write_ix, ".png"), width = 8, height = 4.5, units = "in", res = 400)
  ...
  # Separation
  png(paste0("ceedee_animations/sep_", write_ix, ".png"), width = 8, height = 4.5, units = "in", res = 400)
  par(mar = c(3,3,2,1), mgp = c(1.8, 0.5, 0))
